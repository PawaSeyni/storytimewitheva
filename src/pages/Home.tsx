...
const TRANSLATIONS = {
  en: {
    ...
    heroSubtitle: 'Discover magical books, fun activities, and reading adventures for curious minds ages 3–9 with Eva',
    ...
    hiw: [
      { emoji: '🔍', title: 'Browse', desc: "Explore Eva's books and multilingual activities" },
  ...
  es: {
    ...
    heroSubtitle: 'Descubre libros bilingües mágicos, actividades divertidas y aventuras de lectura para mentes curiosas de 3 a 9 años con Eva',
    ...
    hiw: [
      { emoji: '🔍', title: 'Explora', desc: 'Explora los libros de Eva y actividades multilingües' },
  ...
  fr: {
    ...
    heroSubtitle: 'Découvrez des livres bilingues magiques, des activités amusantes et des aventures de lecture pour les esprits curieux de 3 à 9 ans avec Eva',
    ...
    hiw: [
      { emoji: '🔍', title: 'Explorer', desc: "Explorez les livres d'Eva et des activités multilingues" },
