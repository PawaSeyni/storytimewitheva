      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            {raw && (
              <div className="mb-5">
                <p className="text-sm font-semibold text-gray-700">{book.languages.includes('🇫🇷') ? t.bookLangsEnFr : t.bookLangs}</p>
