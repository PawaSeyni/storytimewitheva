...
const TRANSLATIONS = {
  en: {
    ...
    faqs: [
      ...
      { q: 'Are the activities and downloads really free?', a: 'Yes. All of the activities, read-alongs, and the 20-page trilingual starter kit are free. Only the books themselves are paid (on Amazon).' },
      { q: 'Do you collect any information about my child?', a: 'No. There are no child accounts or logins, and we don’t collect personal information from children. Reading progress is saved only in your browser and never sent to us. The only thing we collect is a parent’s email address if you choose to join the newsletter. See our Privacy Policy for details.' },
  ...
  es: {
    ...
    faqs: [
      ...
      { q: '¿Las actividades y descargas son realmente gratis?', a: 'Sí. Todas las actividades, las lecturas en voz alta y el kit de inicio trilingüe de 20 páginas son gratis. Solo los libros tienen costo (en Amazon).' },
      { q: '¿Recopilan información sobre mi hijo/a?', a: 'No. No hay cuentas ni inicios de sesión para niños, y no recopilamos información personal de menores. El progreso de lectura se guarda solo en tu navegador y nunca se nos envía. Lo único que recopilamos es el correo de un adulto si decides unirte al boletín. Consulta nuestra Política de privacidad.' },
