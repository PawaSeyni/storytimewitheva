...
| App CSS, gzip | 40 KB | 60 KB | 35 KB at baseline; 17 KB after Tailwind 4 |
| Games stylesheet (`/games/games.css`), gzip | 30 KB | 40 KB | 24 KB (v3), 25 KB (v4); loaded only by the twelve static games |
