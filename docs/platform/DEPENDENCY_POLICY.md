...
Netlify and CI, 22 locally. After the non-breaking `npm audit fix` in #180, four advisories
remain, all needing a major: vite 5 and esbuild (dev-server-only path traversal / request
