...
| Newsletter: view → start → lead | `Form View` → `Form Start` → `Lead Created` | placement, lead_magnet, language | outcome: Lead Created is backend-confirmed creation (single opt-in). |
