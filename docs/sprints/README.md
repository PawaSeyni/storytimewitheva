...
| S7-007 | ✅ shipped | Three `educator` collection records (feelings, bilingual read-alouds, STEM), audience-labeled, validated, routed through the collections gate, linked from the teachers section of `/resources` (#171). S7-008's downloadable packs are NOT this: the records reference the existing printables |
